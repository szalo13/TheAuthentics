...
var _createClass = function() {
        ...
        var b = "alert",
            ...
            l = function() {
                ...
                return b.prototype.close = function(a) {
                    ...
                    var c = this;
                    return a(b).removeClass(k.SHOW), Util.supportsTransitionEnd() && a(b).hasClass(k.FADE) ? void a(b).one(Util.TRANSITION_END, function(a) {
                        return c._destroyElement(b, a)
                    }).emulateTransitionEnd(h) : void this._destroyElement(b)
    ...
    Collapse = function(a) {
        var b = "collapse",
            ...
            o = function() {
                function e(b, c) {
                    _classCallCheck(this, e), this._isTransitioning = !1, this._element = b, this._config = this._getConfig(c), this._triggerArray = a.makeArray(a('[data-toggle="collapse"][href="#' + b.id + '"],' + ('[data-toggle="collapse"][data-target="#' + b.id + '"]'))), this._parent = this._config.parent ? this._getParent() : null, this._config.parent || this._addAriaAndCollapsedClass(this._element, this._triggerArray), this._config.toggle && this.toggle()
                }
                return e.prototype.toggle = function() {
                    ...
                    if (!a(this._element).hasClass(l.SHOW)) {
                        var c = void 0,
                            f = void 0;
                        if (this._parent && (c = a.makeArray(a(this._parent).find(n.ACTIVES)), c.length || (c = null)), !(c && (f = a(c).data(d), f && f._isTransitioning))) {
                ...
                }, e.prototype._getConfig = function(c) {
                    return c = a.extend({}, i, c), c.toggle = Boolean(c.toggle), Util.typeCheckConfig(b, c, j), c
                    ...
                    return this.each(function() {
                        var c = a(this),
                            f = c.data(d),
                            g = a.extend({}, i, c.data(), "object" === ("undefined" == typeof b ? "undefined" : _typeof(b)) && b);
                        if (!f && g.toggle && /show|hide/.test(b) && (g.toggle = !1), f || (f = new e(this, g), c.data(d, f)), "string" == typeof b) {
    ...
    Dropdown = function(a) {
        var b = "dropdown",
            ...
            o = function() {
                ...
                return b.prototype.toggle = function() {
                    if (this.disabled || a(this).hasClass(m.DISABLED)) return !1;
                    var c = b._getParentFromElement(this),
                        d = a(c).hasClass(m.SHOW);
                    if (b._clearMenus(), d) return !1;
                    if ("ontouchstart" in document.documentElement && !a(c).closest(n.NAVBAR_NAV).length) {
                        var e = document.createElement("div");
                        e.className = m.BACKDROP, a(e).insertBefore(this), a(e).on("click", b._clearMenus)
                    }
                    var f = {
                            relatedTarget: this
                        },
                        g = a.Event(l.SHOW, f);
                    return a(c).trigger(g), !g.isDefaultPrevented() && (this.focus(), this.setAttribute("aria-expanded", !0), a(c).toggleClass(m.SHOW), a(c).trigger(a.Event(l.SHOWN, f)), !1)
                }, b.prototype.dispose = function() {
                    ...
                    return this.each(function() {
                        var e = a(this).data(d);
                        if (e || (e = new b(this), a(this).data(d, e)), "string" == typeof c) {
                    ...
                    if (!c || c.which !== k) {
                        var d = a(n.BACKDROP)[0];
                        d && d.parentNode.removeChild(d);
                        for (var e = a.makeArray(a(n.DATA_TOGGLE)), f = 0; f < e.length; f++) {
                            var g = b._getParentFromElement(e[f]),
                                h = {
                                    relatedTarget: e[f]
                                };
                            if (a(g).hasClass(m.SHOW) && !(c && ("click" === c.type && /input|textarea/i.test(c.target.tagName) || "focusin" === c.type) && a.contains(g, c.target))) {
                                var i = a.Event(l.HIDE, h);
                                a(g).trigger(i), i.isDefaultPrevented() || (e[f].setAttribute("aria-expanded", "false"), a(g).removeClass(m.SHOW).trigger(a.Event(l.HIDDEN, h)))
                            }
                        }
                    }
                }, b._getParentFromElement = function(b) {
                    var c = void 0,
                        d = Util.getSelectorFromElement(b);
                    return d && (c = a(d)[0]), c || b.parentNode
                }, b._dataApiKeydownHandler = function(c) {
                    if (/(38|40|27|32)/.test(c.which) && !/input|textarea/i.test(c.target.tagName) && (c.preventDefault(), c.stopPropagation(), !this.disabled && !a(this).hasClass(m.DISABLED))) {
                        var d = b._getParentFromElement(this),
                            e = a(d).hasClass(m.SHOW);
                        if (!e && c.which !== h || e && c.which === h) {
                            if (c.which === h) {
                                var f = a(d).find(n.DATA_TOGGLE)[0];
                                a(f).trigger("focus")
                            }
                            return void a(this).trigger("click")
                        }
                        var g = a(d).find(n.VISIBLE_ITEMS).get();
                        if (g.length) {
                            var k = g.indexOf(c.target);
                            c.which === i && k > 0 && k--, c.which === j && k < g.length - 1 && k++, k < 0 && (k = 0), g[k].focus()
                        }
                    }
                }, _createClass(b, null, [{
                    key: "VERSION",
        ...
        return a(document).on(l.KEYDOWN_DATA_API, n.DATA_TOGGLE, o._dataApiKeydownHandler).on(l.KEYDOWN_DATA_API, n.ROLE_MENU, o._dataApiKeydownHandler).on(l.KEYDOWN_DATA_API, n.ROLE_LISTBOX, o._dataApiKeydownHandler).on(l.CLICK_DATA_API + " " + l.FOCUSIN_DATA_API, o._clearMenus).on(l.CLICK_DATA_API, n.DATA_TOGGLE, o.prototype.toggle).on(l.CLICK_DATA_API, n.FORM_CHILD, function(a) {
            a.stopPropagation()
        }), a.fn[b] = o._jQueryInterface, a.fn[b].Constructor = o, a.fn[b].noConflict = function() {
            return a.fn[b] = g, o._jQueryInterface
        }, o
            ...
            l = function() {
                ...
                return b.prototype.show = function() {
                    ...
                    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && a(this._element).hasClass(j.ACTIVE) || a(this._element).hasClass(j.DISABLED))) {
                        var c = void 0,
                            d = void 0,
                            e = a(this._element).closest(k.LIST)[0],
                            f = Util.getSelectorFromElement(this._element);
                    ...
                    var e = this,
                        f = a(c).find(k.ACTIVE_CHILD)[0],
                        g = d && Util.supportsTransitionEnd() && (f && a(f).hasClass(j.FADE) || Boolean(a(c).find(k.FADE_CHILD)[0])),
                        i = function() {
                            return e._transitionComplete(b, f, g, d)
                        };
                    f && g ? a(f).one(Util.TRANSITION_END, i).emulateTransitionEnd(h) : i(), f && a(f).removeClass(j.SHOW)
                }, b.prototype._transitionComplete = function(b, c, d, e) {
                    if (c) {
                        a(c).removeClass(j.ACTIVE);
                        var f = a(c.parentNode).find(k.DROPDOWN_ACTIVE_CHILD)[0];
                        f && a(f).removeClass(j.ACTIVE), c.setAttribute("aria-expanded", !1)
                    }
                    if (a(b).addClass(j.ACTIVE), b.setAttribute("aria-expanded", !0), d ? (Util.reflow(b), a(b).addClass(j.SHOW)) : a(b).removeClass(j.FADE), b.parentNode && a(b.parentNode).hasClass(j.DROPDOWN_MENU)) {
...
function() {
    ...
    function b() {
        e = a.innerWidth || document.documentElement.clientWidth, f = a.innerHeight || document.documentElement.clientHeight
    }
    ...
    function d(c) {
        a.requestAnimationFrame(function() {
            "scroll" !== c.type && b();
            for (var a = 0, d = o.length; a < d; a++) "scroll" !== c.type && (o[a].coverImage(), o[a].clipContainer()), o[a].onScroll()
        })
    }
    ...
    var e, f, g = function() {
            ...
            (document.body || document.documentElement).insertBefore(c, null);
            for (var e in d) "undefined" != typeof c.style[e] && (c.style[e] = "translate3d(1px,1px,1px)", b = a.getComputedStyle(c).getPropertyValue(d[e]));
            return (document.body || document.documentElement).removeChild(c), "undefined" != typeof b && b.length > 0 && "none" !== b
        }(),
        h = navigator.userAgent.toLowerCase().indexOf("android") > -1,
        i = /iPad|iPhone|iPod/.test(navigator.userAgent) && !a.MSStream,
        j = !!a.opera,
        k = /Edge\/\d+/.test(navigator.userAgent),
        l = /Trident.*rv[ :]*11\./.test(navigator.userAgent),
        m = !!Function("/*@cc_on return document.documentMode===10@*/")(),
        n = document.all && !a.atob;
    b();
    var o = [],
        p = function() {
            function a(a, c) {
                var d, e = this;
                if (e.$item = a, e.defaults = {
                        type: "scroll",
                        speed: .5,
                        imgSrc: null,
                        imgWidth: null,
                        ...
                        onDestroy: null,
                        onCoverImage: null
                    }, d = JSON.parse(e.$item.getAttribute("data-jarallax") || "{}"), e.options = e.extend({}, e.defaults, d, c), !(h && e.options.noAndroid || i && e.options.noIos)) {
                    e.options.speed = Math.min(2, Math.max(-1, parseFloat(e.options.speed)));
                    var f = e.options.elementInViewport;
                    f && "object" == typeof f && "undefined" != typeof f.length && (f = f[0]), !f instanceof Element && (f = null), e.options.elementInViewport = f, e.instanceID = b++, e.image = {
                        src: e.options.imgSrc || null,
                        $container: null,
                        $item: null,
                        width: e.options.imgWidth || null,
                        height: e.options.imgHeight || null,
                        useImgTag: i || h || j || l || m || k
                    }, e.initImg() && e.init()
                }
            }
            var b = 0;
    ...
    p.prototype.css = function(b, c) {
        ...
        function a() {
            b.coverImage(), b.clipContainer(), b.onScroll(!0), b.$item.setAttribute("data-jarallax-original-styles", b.$item.getAttribute("style")), b.options.onInit && b.options.onInit.call(b), setTimeout(function() {
                b.$item && b.css(b.$item, {
        ...
        b.image.$container = document.createElement("div"), b.css(b.image.$container, c), b.css(b.image.$container, {
            visibility: "hidden",
            "z-index": b.options.zIndex
        }), b.image.$container.setAttribute("id", "jarallax-container-" + b.instanceID), b.$item.appendChild(b.image.$container), b.image.useImgTag && g && b.options.enableTransform ? (b.image.$item = document.createElement("img"), b.image.$item.setAttribute("src", b.image.src), d = b.extend({
            "max-width": "none"
        }, c, d)) : (b.image.$item = document.createElement("div"), d = b.extend({
            "background-position": "50% 50%",
            "background-size": "100% auto",
            "background-repeat": "no-repeat no-repeat",
            "background-image": 'url("' + b.image.src + '")'
        }, c, d)), n && (d.backgroundAttachment = "fixed"), b.parentWithTransform = 0;
        for (var e = b.$item; null !== e && e !== document && 0 === b.parentWithTransform;) {
            var f = b.css(e, "-webkit-transform") || b.css(e, "-moz-transform") || b.css(e, "transform");
            f && "none" !== f && (b.parentWithTransform = 1, b.css(b.image.$container, {
                transform: "translateX(0) translateY(0)"
            })), e = e.parentNode
        }
        b.css(b.image.$item, d), b.image.$container.appendChild(b.image.$item), b.image.width && b.image.height ? a() : b.getImageSize(b.image.src, function(c, d) {
            b.image.width = c, b.image.height = d, a()
        }), o.push(b)
    }, p.prototype.destroy = function() {
        for (var a = this, b = 0, c = o.length; b < c; b++)
            if (o[b].instanceID === a.instanceID) {
                o.splice(b, 1);
                break
            }
    ...
    }, p.prototype.getImageSize = function(a, b) {
        if (a && b) {
            var c = new Image;
            c.onload = function() {
                b(c.width, c.height)
    ...
    }, p.prototype.clipContainer = function() {
        if (!n) {
            var a = this,
    ...
    }, p.prototype.coverImage = function() {
        var a = this;
        if (a.image.width && a.image.height) {
            var b = a.image.$container.getBoundingClientRect(),
                c = b.width,
                d = b.height,
                e = b.left,
                h = a.image.width,
                i = a.image.height,
                j = a.options.speed,
                k = "scroll" === a.options.type || "scroll-opacity" === a.options.type,
                l = 0,
                m = 0,
                n = d,
                o = 0,
                p = 0;
            k && (l = j * (d + f) / 2, (j < 0 || j > 1) && (l = j * Math.max(d, f) / 2), j < 0 || j > 1 ? n = Math.max(d, f) + 2 * Math.abs(l) : n += Math.abs(f - d) * (1 - j)), m = n * h / i, m < c && (m = c, n = m * i / h), a.bgPosVerticalCenter = 0, !(k && n < f) || g && a.options.enableTransform || (a.bgPosVerticalCenter = (f - n) / 2, n = f), k ? (o = e + (c - m) / 2, p = (f - n) / 2) : (o = (c - m) / 2, p = (d - n) / 2), g && a.options.enableTransform && a.parentWithTransform && (o -= e), a.parallaxScrollDistance = l, a.css(a.image.$item, {
                width: m + "px",
                height: n + "px",
                marginLeft: o + "px",
                marginTop: p + "px"
    ...
    }, p.prototype.onScroll = function(a) {
        var b = this;
        if (b.image.width && b.image.height) {
            var c = b.$item.getBoundingClientRect(),
                d = c.top,
                h = c.height,
                i = {
                    position: "absolute",
                ...
                j = c;
            if (b.options.elementInViewport && (j = b.options.elementInViewport.getBoundingClientRect()), b.isElementInViewport = j.bottom >= 0 && j.right >= 0 && j.top <= f && j.left <= e, a || b.isElementInViewport) {
                var k = Math.max(0, d),
                    l = Math.max(0, h + d),
                    m = Math.max(0, -d),
                    o = Math.max(0, d + h - f),
                    p = Math.max(0, h - (d + h - f)),
                    q = Math.max(0, -d + f - h),
                    r = 1 - 2 * (f - d) / (f + h),
                    s = 1;
                if (h < f ? s = 1 - (m || o) / h : l <= f ? s = l / f : p <= f && (s = p / f), "opacity" !== b.options.type && "scale-opacity" !== b.options.type && "scroll-opacity" !== b.options.type || (i.transform = "translate3d(0, 0, 0)", i.opacity = s), "scale" === b.options.type || "scale-opacity" === b.options.type) {
                    var t = 1;
                    b.options.speed < 0 ? t -= b.options.speed * s : t += b.options.speed * (1 - s), i.transform = "scale(" + t + ") translate3d(0, 0, 0)"
                }
                if ("scroll" === b.options.type || "scroll-opacity" === b.options.type) {
                    var u = b.parallaxScrollDistance * r;
                    g && b.options.enableTransform ? (b.parentWithTransform && (u -= d), i.transform = "translate3d(0, " + u + "px, 0)") : b.image.useImgTag ? i.top = u + "px" : (b.bgPosVerticalCenter && (u += b.bgPosVerticalCenter), i.backgroundPosition = "50% " + u + "px"), i.position = n ? "absolute" : "fixed"
                }
                b.css(b.image.$item, i), b.options.onScroll && b.options.onScroll.call(b, {
                    section: c,
                    beforeTop: k,
                    beforeTopEnd: l,
                    afterTop: m,
    ...
    }, c(a, "scroll", d), c(a, "resize", d), c(a, "orientationchange", d), c(a, "load", d);
    var q = function(a) {
        ...
        var b, c = arguments[1],
            ...
            f = 0;
        for (f; f < e; f++)
            if ("object" == typeof c || "undefined" == typeof c ? a[f].jarallax || (a[f].jarallax = new p(a[f], c)) : a[f].jarallax && (b = a[f].jarallax[c].apply(a[f].jarallax, d)), "undefined" != typeof b) return b;
        return a
    };
    q.constructor = p;
    var r = a.jarallax;
    ...
    var e = function() {
        function a(a, d) {
            ...
            e.url = a, e.options_default = {
                ...
                startTime: 0,
                endTime: 0
            }, e.options = b({}, e.options_default, d), e.videoID = e.parseURL(a), e.videoID && (e.ID = c++, e.loadAPI(), e.init())
        }
        var c = 0;
        return a
    }();
    e.prototype.parseURL = function(a) {
        function b(a) {
            var b = /.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/,
                c = a.match(b);
            return !(!c || 11 !== c[1].length) && c[1]
        }

        function c(a) {
            var b = /https?:\/\/(?:www\.|player\.)?vimeo.com\/(?:channels\/(?:\w+\/)?|groups\/([^\/]*)\/videos\/|album\/(\d+)\/video\/|video\/|)(\d+)(?:$|\/|\?)/,
                c = a.match(b);
            return !(!c || !c[3]) && c[3]
        }

        function d(a) {
            for (var b = a.split(/,(?=mp4\:|webm\:|ogv\:|ogg\:)/), c = {}, d = 0, e = 0; e < b.length; e++) {
                var f = b[e].match(/^(mp4|webm|ogv|ogg)\:(.*)/);
                f && f[1] && f[2] && (c["ogv" === f[1] ? "ogg" : f[1]] = f[2], d = 1)
            }
            return !!d && c
        }
        var e = b(a),
            f = c(a),
            g = d(a);
        return e ? (this.type = "youtube", e) : f ? (this.type = "vimeo", f) : !!g && (this.type = "local", g)
    }, e.prototype.isValid = function() {
        return !!this.videoID
    }, e.prototype.on = function(a, b) {
        this.userEventsList = this.userEventsList || [], (this.userEventsList[a] || (this.userEventsList[a] = [])).push(b)
    }, e.prototype.off = function(a, b) {
        if (this.userEventsList && this.userEventsList[a])
            if (b)
                for (var c = 0; c < this.userEventsList[a].length; c++) this.userEventsList[a][c] === b && (this.userEventsList[a][c] = !1);
            else delete this.userEventsList[a]
    }, e.prototype.fire = function(a) {
        var b = [].slice.call(arguments, 1);
        if (this.userEventsList && "undefined" != typeof this.userEventsList[a])
            for (var c in this.userEventsList[a]) this.userEventsList[a][c] && this.userEventsList[a][c].apply(this, b)
    };
    var f = 0;
    e.prototype.play = function(a) {
        var b = this;
        b.player && ("youtube" === b.type && b.player.playVideo && ("undefined" != typeof a && b.player.seekTo(a || 0), b.player.playVideo()), "vimeo" !== b.type || f || ("undefined" != typeof a ? (f = 1, b.player.setCurrentTime(a || 0).then(function() {
            b.player.play(), f = 0
        })) : b.player.play()), "local" === b.type && ("undefined" != typeof a && (b.player.currentTime = a), b.player.play()))
    }, e.prototype.pause = function() {
    ...
    }, e.prototype.getImageURL = function(a) {
        var b = this;
        if (b.videoImage) return void a(b.videoImage);
        if ("youtube" === b.type) {
            var c = ["maxresdefault", "sddefault", "hqdefault", "0"],
                d = 0,
                e = new Image;
            e.onload = function() {
                120 !== (this.naturalWidth || this.width) || d === c.length - 1 ? (b.videoImage = "https://img.youtube.com/vi/" + b.videoID + "/" + c[d] + ".jpg", a(b.videoImage)) : (d++, this.src = "https://img.youtube.com/vi/" + b.videoID + "/" + c[d] + ".jpg")
            }, e.src = "https://img.youtube.com/vi/" + b.videoID + "/" + c[d] + ".jpg"
        }
        if ("vimeo" === b.type) {
            var f = new XMLHttpRequest;
            f.open("GET", "https://vimeo.com/api/v2/video/" + b.videoID + ".json", !0), f.onreadystatechange = function() {
                if (4 === this.readyState && this.status >= 200 && this.status < 400) {
                    var c = JSON.parse(this.responseText);
                    b.videoImage = c[0].thumbnail_large, a(b.videoImage)
                }
            }, f.send(), f = null
        }
    }, e.prototype.getIframe = function(b) {
        var c = this;
        return c.$iframe ? void b(c.$iframe) : void c.onAPIready(function() {
            function e(a, b, c) {
                var d = document.createElement("source");
                d.src = b, d.type = c, a.appendChild(d)
            }
            var f;
            if (c.$iframe || (f = document.createElement("div"), f.style.display = "none"), "youtube" === c.type) {
                c.playerOptions = {}, c.playerOptions.videoId = c.videoID, c.playerOptions.width = a.innerWidth || document.documentElement.clientWidth, c.playerOptions.playerVars = {
                    autohide: 1,
                    rel: 0,
                    autoplay: 0
                }, c.options.controls || (c.playerOptions.playerVars.iv_load_policy = 3, c.playerOptions.playerVars.modestbranding = 1, c.playerOptions.playerVars.controls = 0, c.playerOptions.playerVars.showinfo = 0, c.playerOptions.playerVars.disablekb = 1);
                var g, h;
                c.playerOptions.events = {
                    onReady: function(a) {
                        c.options.mute && a.target.mute(), c.options.autoplay && c.play(c.options.startTime), c.fire("ready", a)
                    },
                    onStateChange: function(a) {
                        c.options.loop && a.data === YT.PlayerState.ENDED && c.play(c.options.startTime), g || a.data !== YT.PlayerState.PLAYING || (g = 1, c.fire("started", a)), a.data === YT.PlayerState.PLAYING && c.fire("play", a), a.data === YT.PlayerState.PAUSED && c.fire("pause", a), a.data === YT.PlayerState.ENDED && c.fire("end", a), c.options.endTime && (a.data === YT.PlayerState.PLAYING ? h = setInterval(function() {
            ...
            if ("vimeo" === c.type) {
                ...
                c.player.on("timeupdate", function(a) {
                    ...
                    c.fire("end", a)
                }), c.player.on("loaded", function(a) {
                    c.fire("ready", a)
                })
            }
            if ("local" === c.type) {
                if (!c.$iframe) {
                    c.$iframe = document.createElement("video"), c.options.mute && c.$iframe.setAttribute("muted", "on"), c.options.loop && c.$iframe.setAttribute("loop", "on"), c.$iframe.setAttribute("id", c.playerID), f.appendChild(c.$iframe), document.body.appendChild(f);
                    for (var l in c.videoID) e(c.$iframe, c.videoID[l], "video/" + l)
                }
                c.player = c.player || c.$iframe;
                var m;
                d(c.player, "playing", function(a) {
                    m || c.fire("started", a), m = 1
                }), d(c.player, "timeupdate", function() {
                    c.options.endTime && c.options.endTime && this.currentTime >= c.options.endTime && (c.options.loop ? c.play(c.options.startTime) : c.pause())
                }), d(c.player, "play", function(a) {
                    c.fire("play", a)
                }), d(c.player, "pause", function(a) {
                    c.fire("pause", a)
                }), d(c.player, "ended", function(a) {
                    c.fire("end", a)
                }), d(c.player, "loadedmetadata", function() {
                    c.fire("ready"), c.options.autoplay && c.play(c.options.startTime)
                })
            }
            b(c.$iframe)
        })
    ...
    e.prototype.loadAPI = function() {
        ...
        if (!g || !h) {
            var c = "";
            if ("youtube" !== b.type || g || (g = 1, c = "//www.youtube.com/iframe_api"), "vimeo" !== b.type || h || (h = 1, c = "//player.vimeo.com/api/player.js"), c) {
                "file://" === a.location.origin && (c = "http:" + c);
                var d = document.createElement("script"),
                    e = document.getElementsByTagName("head")[0];
                d.src = c, e.appendChild(d), e = null, d = null
            }
        }
    };
    var i = 0,
        ...
        k = new c,
        l = new c;
    e.prototype.onAPIready = function(b) {
        var c = this;
        if ("youtube" === c.type && ("undefined" != typeof YT && 0 !== YT.loaded || i ? "object" == typeof YT && 1 === YT.loaded ? b() : k.done(function() {
                b()
            }) : (i = 1, a.onYouTubeIframeAPIReady = function() {
                a.onYouTubeIframeAPIReady = null, k.resolve("done"), b()
            })), "vimeo" === c.type)
            if ("undefined" != typeof Vimeo || j) "undefined" != typeof Vimeo ? b() : l.done(function() {
                b()
            });
            else {
                j = 1;
                var d = setInterval(function() {
                    "undefined" != typeof Vimeo && (clearInterval(d), l.resolve("done"), b())
                }, 20)
            }
        "local" === c.type && b()
    }, a.VideoWorker = e
...
function() {
    ...
    if ("undefined" != typeof jarallax) {
        var a = jarallax.constructor,
            b = a.prototype.init;
        a.prototype.init = function() {
            var a = this;
            b.apply(a), a.video && a.video.getIframe(function(b) {
                var c = b.parentNode;
                a.css(b, {
                    position: "fixed",
                    top: "0px",
                    ...
                    visibility: "visible",
                    zIndex: -1
                }), a.$video = b, a.image.$container.appendChild(b), c.parentNode.removeChild(c)
            })
        };
        var c = a.prototype.coverImage;
        a.prototype.coverImage = function() {
            var a = this;
            c.apply(a), a.video && "IFRAME" === a.image.$item.nodeName && a.css(a.image.$item, {
                height: a.image.$item.getBoundingClientRect().height + 400 + "px",
                marginTop: -200 + parseFloat(a.css(a.image.$item, "margin-top")) + "px"
            })
        };
        var d = a.prototype.initImg;
        a.prototype.initImg = function() {
            var a = this;
            if (a.options.videoSrc || (a.options.videoSrc = a.$item.getAttribute("data-jarallax-video") || !1), a.options.videoSrc) {
                var b = new VideoWorker(a.options.videoSrc, {
                    startTime: a.options.videoStartTime || 0,
                    endTime: a.options.videoEndTime || 0
                });
                if (b.isValid() && (a.image.useImgTag = !0, b.on("ready", function() {
                        var c = a.onScroll;
                        a.onScroll = function() {
                            c.apply(a), a.isVisible() ? b.play() : b.pause()
                        }
                    }), b.on("started", function() {
                        a.image.$default_item = a.image.$item, a.image.$item = a.$video, a.image.width = a.options.imgWidth = a.image.width || 1280,
                            a.image.height = a.options.imgHeight = a.image.height || 720, a.coverImage(), a.clipContainer(), a.onScroll(), a.image.$default_item && (a.image.$default_item.style.display = "none")
                    }), a.video = b, "local" !== b.type && b.getImageURL(function(b) {
                        a.image.src = b, a.init()
                    })), "local" !== b.type) return !1
            }
            return d.apply(a)
        };
        var e = a.prototype.destroy;
        a.prototype.destroy = function() {
            var a = this;
            e.apply(a)
        }
...
function(a) {
    a.fn.theiaStickySidebar = function(b) {
        function c(b, c) {
            var e = d(b, c);
            e || (console.log("TSS: Body width smaller than options.minWidth. Init is delayed."), a(document).scroll(function(b, c) {
                return function(e) {
                    var f = d(b, c);
                    f && a(this).unbind(e)
                }
        ...
        b = a.extend(g, b), b.additionalMarginTop = parseInt(b.additionalMarginTop) || 0, b.additionalMarginBottom = parseInt(b.additionalMarginBottom) || 0, c(b, this)
    }
}(jQuery),
function(a) {
    function b() {
        j >= 768 && (a(".navbar-nav .menu-item-expanded").removeClass("menu-item-expanded").removeAttr("style"), a(".navbar-nav .sub-menu").removeClass("submenu-visible").removeAttr("style"))
    }
    ...
    function d() {
        var b = a(".site-header").innerHeight(),
            c = a("#wpadminbar").innerHeight();
        l.css("margin-top", -c - b + "px"), l.css("padding-top", c + b + "px"), k >= 600 ? l.css("height", k) : l.css("height", "auto"), j >= 768 && k >= 600 ? m.css("padding-bottom", c + b + "px") : m.css("padding-bottom", "0")
    }

    function e(b) {
        if (!c()) {
            var d = a(b.target);
            o = a(".parallax-enabled .owl-featured.owl-parallax .owl-slide:not(.slide-video)"), o.each(function() {
                a(this).jarallax({
                    elementInViewport: d
                })
            }), p = a(".slide-video"), p.each(function() {
                a(this).jarallax({
                    videoSrc: a(this).data("video"),
                    elementInViewport: d,
                    autoplay: 1,
                    loop: 1
                })
    ...
    function f() {
        o = a(".parallax-enabled .owl-featured.owl-parallax .owl-slide"), o.attr("data-jarallax-original-styles") && o.jarallax("clipContainer").jarallax("coverImage").jarallax("onScroll")
    }
    ...
    function g() {
        ...
        var b = a(".site-header").outerHeight(),
            c = a("#wpadminbar").innerHeight(),
            d = a(".owl-slide", s);
        s.css("margin-top", -c - b + "px"), d.css("padding-top", c + b + "px"), k >= 600 ? d.css("height", k) : d.css("height", "600px"), j >= 768 && k >= 600 ? a(".overlay-container", d).css("padding-bottom", c + b + "px") : a(".overlay-container", d).css("padding-bottom", "4rem")
    }
    ...
    a(window).resize(function() {
        j = window.innerWidth, k = window.innerHeight
    }), a.fn.responsiveNav = function() {
        this.removeClass("menu-item-expanded"), this.next().hasClass("submenu-visible") ? (this.next().removeClass("submenu-visible"), this.parent().removeClass("menu-item-expanded"), this.next().slideUp(350)) : (this.parent().parent().find("li.menu-item .sub-menu").removeClass("submenu-visible"), this.parent().parent().find(".menu-item-expanded").removeClass("menu-item-expanded"), this.parent().parent().find("li.menu-item .sub-menu").slideUp(350), this.next().toggleClass("submenu-visible"), this.next().hide(), this.next().slideToggle(350), this.parent().toggleClass("menu-item-expanded"))
    }, a(".navbar-nav li.menu-item-has-children > a").click(function(b) {
        j < 768 ? (b.preventDefault(), a(this).responsiveNav()) : isMobile.any && b.preventDefault()
    }), a(window).resize(function() {
        b()
    }), a(document).ready(function() {
        a(".navbar-brand, .navbar-search").css({
            "line-height": a(".navbar-primary .navbar-nav > li.menu-item > a").innerHeight() + "px"
        })
    }), a(window).resize(function() {
        a(".navbar-brand, .navbar-search").css({
            "line-height": a(".navbar-primary .navbar-nav > li.menu-item > a").innerHeight() + "px"
        })
    }), a(".widget_nav_menu .menu-item-has-children > a").click(function(b) {
        b.preventDefault(), a(this).responsiveNav()
    }), c() || (a(".parallax-enabled .parallax:not(.parallax-video)").jarallax(), a(".parallax-video").each(function() {
        a(this).jarallax({
            videoSrc: a(this).attr("data-video")
        })
    }));
    var l = a(".page-header-large"),
        m = a(".overlay-container", l);
    a(document).ready(function() {
        d()
    }), a(window).resize(function() {
        d();
    });
    var n = a(".post-archive-masonry .row").masonry({
    ...
    n.imagesLoaded().progress(function() {
        ...
        b.preventDefault(), a("#search").addClass("open"), a('#search input[type="search"]').focus(), a("body").addClass("search-open")
    }), a("#search, #search button.close").on("click keyup", function(b) {
        b.target !== this && "close" !== b.target.className && 27 !== b.keyCode || (b.preventDefault(), a(this).removeClass("open"), a("body").removeClass("search-open"))
        ...
        this.each(function() {
            a(this).width() > 120 && a(this).height() > 120 && a(this).hover(function() {
                ...
                c = encodeURIComponent(c), a('<a class="pin-it btn btn-primary btn-lg btn-effect" href="http://www.pinterest.com/pin/create/bookmarklet/?url=' + b + "&amp;media=" + c + '&is_video=false" target="_blank"><span>Pin</span><span><i class="icon icon-pinterest"></i></span></a>').appendTo(this).addClass("pin-it-visible")
            }, function() {
                a(this).children(".pin-it").remove()
            })
        })
    }, a(document).ready(function() {
        a(".content, .post-media").imagesLoaded(function() {
            a(".pin-it-enabled .content figure").not(".gallery-justified figure, .gallery-slider figure").pinIt(), a(".pin-it-enabled .gallery-slider figure").pinIt(), a(".pin-it-enabled.single-format-image .post-media figure").pinIt()
        })
    }), a(".content figure").not(".gallery figure").each(function() {
        var b = a("> a", this).attr("href");
        b && b.match(/\.(gif|jpeg|jpg|png)/) && (a("> a", this).addClass("image-popup"), a(this).magnificPopup({
            delegate: ".image-popup",
            type: "image",
            image: {
                titleSrc: function(a) {
                    return a.el.children().attr("alt")
                }
            }
        }))
    }), a(".gallery-grid, .gallery-slider").each(function() {
        var b = a("figure > a", this).attr("href");
        b && b.match(/\.(gif|jpeg|jpg|png)/) && (a("figure > a", this).addClass("image-popup"), a(this).magnificPopup({
            delegate: ".image-popup",
            type: "image",
            image: {
                titleSrc: function(a) {
    ...
    }), a(".single-format-image .post-media figure > a").addClass("image-popup").magnificPopup({
        type: "image",
        image: {
            titleSrc: function(a) {
                return a.el.children().attr("alt")
        ...
        a(".sticky-sidebar-enabled .sidebar, .post-sidebar").theiaStickySidebar({
            additionalMarginTop: a(".navbar-scroll-enabled .navbar-primary").innerHeight() + a("#wpadminbar").innerHeight() + 40,
            additionalMarginBottom: 40,
            minWidth: 545
        })
    });
    var o = a(".parallax-enabled .owl-featured.owl-parallax .owl-slide:not(.slide-video)"),
        p = a(".owl-featured .slide-video"),
        q = a(".owl-center");
    q.each(function() {
        function b(b) {
            var c = a(b.target);
            a(".owl-arrows > div", c.parent()).css("width", (c.innerWidth() - a(".owl-item.center", c).innerWidth() - 80) / 2 + "px")
        }
        ...
        h.owlCarousel({
            ...
            dragEndSpeed: 500,
            smartSpeed: 500,
            dotsContainer: a("> .owl-dots", g),
            navContainer: a("> .owl-arrows", g),
            navText: ["", ""],
            responsive: {
                0: {
                    items: 1,
    ...
    r.each(function() {
        ...
        c.owlCarousel({
            ...
            items: 1,
            margin: 0,
            navText: ['<div class="btn btn-primary btn-effect"><span><i class="icon icon-chevron-up"></i></span><span>' + translation.previous + "</span></div>", '<div class="btn btn-primary btn-effect"><span><i class="icon icon-chevron-up"></i></span><span>' + translation.next + "</span></div>"],
            dots: !0,
            dotsContainer: a("> .owl-dots", b),
            responsive: {
                0: {
                    nav: !1
                },
        ...
        c.owlCarousel({
            ...
            responsive: {
                ...
                1200: {
                    ...
                    margin: 3,
                    stagePadding: 100,
                    items: a(this).data("slides-visible")
                }
            },
            onInitialized: e,
            onResized: f
    ...
    var x = {};
    x = "undefined" != typeof csco_settings && "justified_gallery" in csco_settings ? csco_settings.justified_gallery : {
        border: 0,
        margins: 10,
        lastRow: "justify",
        rowHeight: 300,
    ...
    }, a(".gallery-justified").justifiedGallery(x).on("jg.complete", function(b) {
        a(".pin-it-enabled").find(a("figure", this)).pinIt();
        var c = a("figure > a", this).attr("href");
        c && c.match(/\.(gif|jpeg|jpg|png)/) && (a("figure > a", this).addClass("image-popup"), a(this).magnificPopup({
            delegate: ".image-popup",
            type: "image",
            image: {
                titleSrc: function(a) {
    ...
    }), a(".lazy-load-enabled .post-archive .post").waypoint(function(b) {
        a(this.element).addClass("post-visible")
    }, {
        offset: "100%"
    }), a(".single-post .page-content").waypoint(function(b) {
        "down" === b ? a(".post-pagination").addClass("") : a(".post-pagination").removeClass("")
    }), a(".single-post .site-footer").waypoint(function(b) {
        "down" === b ? a(".post-pagination").removeClass("") : a(".post-pagination").addClass("")
    }, {
        offset: "75%"
    }), a(document).ready(function() {
        var b = a(".navbar-scroll-enabled .header-navbar-primary");
        b.length && new Waypoint.Sticky({
            element: a(b)[0],
            direction: "down",
            stuckClass: "header-navbar-stuck",
            offset: a("#wpadminbar").innerHeight()
        })
    }), a(".navbar-scroll-enabled .header-navbar-primary").headroom({
        offset: k,
        classes: {
            initial: "header-navbar-scroll",
            pinned: "header-navbar-pinned",
            unpinned: "",
            top: "header-navbar-top",
            notTop: "header-navbar-not-top",
            bottom: "header-navbar-bottom",
            notBottom: "header-navbar-not-bottom"
        }
    })
}(jQuery);
